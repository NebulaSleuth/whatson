...
sub onContentChanged()
    ...
    ' Background colour — live cards stay surface dark, upcoming cards
    ' adopt the followed/home team's primary colour. bgColor arrives as
    ' "0xRRGGBBff" (or empty when no usable colour was found).
    bgColor = content.bgColor
    if isLive or bgColor = invalid or bgColor = ""
    ...
    ' Live cards always use white over the surface dark.
    ...
    m.team1Score.visible = showTeams and isLive
    m.team2Logo.visible = showTeams
    m.team2Name.visible = showTeams
    m.team2Score.visible = showTeams and isLive
