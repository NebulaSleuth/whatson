...
export function PosterCard({ item, onClick }: Props) {
  ...
  return (
    ...
    >
      <div className="relative w-[180px] h-[270px] rounded-xl overflow-hidden bg-surface border-2 border-transparent group-hover:border-primary group-focus:border-primary transition-colors">
        {poster ? (
          <img
            src={poster}
            alt={item.title}
